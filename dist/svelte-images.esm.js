...
version: 0.0.1
*/
import { SvelteComponent, init, safe_not_equal, element, append, space, attr, set_attributes, toggle_class, insert, group_outros, transition_out, check_outros, transition_in, get_spread_update, detach, destroy_each, assign, noop, listen, add_render_callback, create_in_transition, create_out_transition, set_style, create_component, mount_component, get_spread_object, create_bidirectional_transition, destroy_component, create_slot, get_slot_context, get_slot_changes, binding_callbacks, exclude_internal_props } from 'svelte/internal';
...
function create_else_block_1(ctx) {
  ...
  return {
    c() {
      div = element("div");
      attr(div, "class", "empty svelte-1m10vl8");
    },
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      ...
      attr(button, "class", "svelte-1m10vl8");
    },
...
function create_each_block(ctx) {
  ...
  return {
    c() {
      ...
      img = element("img");
      t2 = space();
      attr(div0, "class", "nav svelte-1m10vl8");
      set_attributes(img, img_data);
      toggle_class(img, "svelte-1m10vl8", true);
      attr(div1, "class", "img-container svelte-1m10vl8");
    },
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "carousel svelte-1m10vl8");
      attr(div, "style", div_style_value = `transform: translate3d(${
      /*translateX*/
      ctx[2]}px, 0, 0);`);
    },
...
function create_each_block$1(ctx) {
  ...
  return {
    c() {
      ...
      t = space();
      set_attributes(img, img_data);
      toggle_class(img, "svelte-lk00e3", true);
      attr(div, "class", "img-container svelte-lk00e3");
    },
...
function create_fragment$1(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "gallery svelte-lk00e3");
      set_style(div, "--gutter",
      /*gutter*/
      ctx[1]);
    },
...
function create_if_block$1(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "content svelte-p7calc");
      attr(div0, "style",
      /*cssContent*/
      ctx[10]);
      attr(div1, "class", "window svelte-p7calc");
      attr(div1, "style",
      /*cssWindow*/
      ctx[9]);
      attr(div2, "class", "window-wrap svelte-p7calc");
      attr(div3, "class", "bg svelte-p7calc");
      attr(div3, "style",
      /*cssBg*/
      ctx[8]);
    },
    ...
    p(ctx, dirty) {
      ...
      /*props*/
      32 ? get_spread_update(component_spread_levels, [get_spread_object(
      /*props*/
      ctx[5])]) : {};
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      134217728) {
        ...
        /*$$scope*/
        ctx[27], null), get_slot_changes(default_slot_template,
        /*$$scope*/
        ctx[27], dirty, null));
      }
    },
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  let {
    setContext: setContext$1 = setContext
  } = $$props;
  let Component = null;
  let props = null;
  let background;
  ...
  return [transitionBg, transitionBgProps, transitionWindow, transitionWindowProps, Component, props, background, wrap, cssBg, cssWindow, cssContent, handleKeyup, handleOuterClick, key, closeOnEsc, closeOnOuterClick, styleBg, styleWindow, styleContent, setContext$1, customStyleBg, customStyleWindow, customStyleContent, camelCaseToDash, toCssString, open, close, $$scope, $$slots, div2_binding, div3_binding];
}
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    p(ctx, dirty) {
      ...
      /*$$props*/
      1 ? get_spread_update(images_spread_levels, [get_spread_object(
      /*$$props*/
      ctx[0])]) : {};
...
function create_fragment$3(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "svelte-images-container svelte-ot3ccz");
    },
...
class Images_1 extends SvelteComponent {
  constructor(options) {
    super();
...
//# sourceMappingURL=svelte-images.esm.js.map
