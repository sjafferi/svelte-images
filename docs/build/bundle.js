...
var app = (function () {
    ...
    const file = "src/Images/Modal.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 72, 8, 1464);
    			attr_dev(div1, "class", "window-wrap svelte-rppnts");
    			add_location(div1, file, 68, 6, 1353);
    			attr_dev(div2, "class", "bg svelte-rppnts");
    			add_location(div2, file, 63, 4, 1219);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 61, 0, 1194);
    		},
    ...
    const file$1 = "src/Images/ClickOutside.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 26, 0, 656);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class ClickOutside extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { exclude: 3, className: 0 });
    ...
    const file$2 = "src/Images/Carousel.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	let i = /*i*/ ctx[18];
    	let t;
    	let img_levels = [/*image*/ ctx[16], { alt: /*image*/ ctx[16].alt || "" }];
    	let img_data = {};
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 161, 10, 3583);
    			attr_dev(div, "class", "img-container svelte-1szv2de");
    			add_location(div, file$2, 160, 8, 3545);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			set_attributes(img, get_spread_update(img_levels, [
    				dirty & /*images*/ 1 && /*image*/ ctx[16],
    				dirty & /*images*/ 1 && { alt: /*image*/ ctx[16].alt || "" }
    			]));
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$2, 152, 2, 3250);
    			attr_dev(div2, "class", "container svelte-1szv2de");
    			add_location(div2, file$2, 138, 0, 2754);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Carousel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { images: 0, curr_idx: 9 });
    ...
    const file$3 = "src/Images/Images.svelte";
    ...
    class Images extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { images: 0, gutter: 1, numCols: 2 });
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$4, 13, 0, 206);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
