...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 25, 0, 626);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			assign_button();
    			current = true;
    			dispose = listen_dev(button, "click", /*left*/ ctx[8], false, false, false);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	let current;
    	let dispose;
    	const assign_button = () => /*button_binding_1*/ ctx[12](button, i);
    	const unassign_button = () => /*button_binding_1*/ ctx[12](null, i);
    ...
    function create_default_slot(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*blink*/ ctx[6] && /*curr_idx*/ ctx[0] > 0) return 0;
    		return 1;
    	}
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*blink*/ ctx[6] && /*curr_idx*/ ctx[0] < /*images*/ ctx[1].length - 1) return 0;
    		return 1;
    	}

    	current_block_type_index_1 = select_block_type_1(ctx);
    	if_block1 = if_blocks_1[current_block_type_index_1] = if_block_creators_1[current_block_type_index_1](ctx);
    	let img_levels = [/*image*/ ctx[13], { alt: /*image*/ ctx[13].alt || "" }];
    	let img_data = {};
    ...
    function create_each_block(ctx) {
    	...
    	const clickoutside = new ClickOutside({
    			props: {
    				...
    				exclude: [.../*left_nav_buttons*/ ctx[3], .../*right_nav_buttons*/ ctx[4]],
    	...
    	clickoutside.$on("clickoutside", /*close*/ ctx[2]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*left_nav_buttons, right_nav_buttons*/ 24) clickoutside_changes.exclude = [.../*left_nav_buttons*/ ctx[3], .../*right_nav_buttons*/ ctx[4]];

    			if (dirty & /*$$scope, images, right_nav_buttons, blink, curr_idx, left_nav_buttons*/ 65627) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*left_nav_buttons, right_nav_buttons, close, images, right, blink, curr_idx, left*/ 479) {
    			...
    			if (!current || dirty & /*translateX*/ 32 && div_style_value !== (div_style_value = `transform: translate3d(${/*translateX*/ ctx[5]}px, 0, 0);`)) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function doBlink() {
    		$$invalidate(6, blink = false);
    		setTimeout(() => $$invalidate(6, blink = true), blinkDelay);
    	}

    	function right() {
    		doBlink();
    		$$invalidate(0, curr_idx = increment(curr_idx));
    		$$invalidate(5, translateX -= window.innerWidth);
    	}
    	...
    	function button_binding($$value, i) {
    		if (left_nav_buttons[i] === $$value) return;

    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			left_nav_buttons[i] = $$value;
    			$$invalidate(3, left_nav_buttons);
    		});
    	}

    	function button_binding_1($$value, i) {
    		if (right_nav_buttons[i] === $$value) return;

    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			right_nav_buttons[i] = $$value;
    			$$invalidate(4, right_nav_buttons);
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("blink" in $$props) $$invalidate(6, blink = $$props.blink);
    	};
    ...
    class Carousel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { images: 1, close: 2, curr_idx: 0 });
    		...
    		if (/*close*/ ctx[2] === undefined && !("close" in props)) {
    ...
    /* src/Images/ModalBg.svelte generated by Svelte v3.18.1 */
    const file$3 = "src/Images/ModalBg.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			if (default_slot) default_slot.c();
    			attr_dev(div0, "class", "content svelte-cdbrdf");
    			add_location(div0, file$3, 42, 6, 984);
    			attr_dev(div1, "class", "window svelte-cdbrdf");
    			add_location(div1, file$3, 41, 4, 905);
    			attr_dev(div2, "class", "window-wrap svelte-cdbrdf");
    			add_location(div2, file$3, 40, 2, 858);
    			attr_dev(div3, "class", "bg svelte-cdbrdf");
    			add_location(div3, file$3, 35, 0, 736);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			current = true;
    			dispose = listen_dev(div3, "click", /*handleOuterClick*/ ctx[6], false, false, false);
    		},
    		p: function update(ctx, [dirty]) {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div1_transition) div1_transition = create_bidirectional_transition(div1, /*transitionWindow*/ ctx[4], /*transitionWindowProps*/ ctx[5], true);
    				div1_transition.run(1);
    			});

    			add_render_callback(() => {
    				if (!div3_transition) div3_transition = create_bidirectional_transition(div3, /*transitionBg*/ ctx[2], /*transitionBgProps*/ ctx[3], true);
    		...
    		o: function outro(local) {
    			transition_out(default_slot, local);
    			if (!div1_transition) div1_transition = create_bidirectional_transition(div1, /*transitionWindow*/ ctx[4], /*transitionWindowProps*/ ctx[5], false);
    			div1_transition.run(0);
    			if (!div3_transition) div3_transition = create_bidirectional_transition(div3, /*transitionBg*/ ctx[2], /*transitionBgProps*/ ctx[3], false);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ModalBg> was created with unknown prop '${key}'`);
    	});
    	...
    	function div2_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(1, wrap = $$value);
    		});
    	}

    	function div3_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(0, background = $$value);
    		});
    	}

    	$$self.$set = $$props => {
    		if ("transitionBg" in $$props) $$invalidate(2, transitionBg = $$props.transitionBg);
    		if ("transitionBgProps" in $$props) $$invalidate(3, transitionBgProps = $$props.transitionBgProps);
    		if ("transitionWindow" in $$props) $$invalidate(4, transitionWindow = $$props.transitionWindow);
    		if ("transitionWindowProps" in $$props) $$invalidate(5, transitionWindowProps = $$props.transitionWindowProps);
    		if ("handleOuterClick" in $$props) $$invalidate(6, handleOuterClick = $$props.handleOuterClick);
    		if ("background" in $$props) $$invalidate(0, background = $$props.background);
    		if ("wrap" in $$props) $$invalidate(1, wrap = $$props.wrap);
    ...
    class ModalBg extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*handleOuterClick*/ ctx[6] === undefined && !("handleOuterClick" in props)) {
    			console.warn("<ModalBg> was created without expected prop 'handleOuterClick'");
    		}

    		if (/*background*/ ctx[0] === undefined && !("background" in props)) {
    			console.warn("<ModalBg> was created without expected prop 'background'");
    		}

    		if (/*wrap*/ ctx[1] === undefined && !("wrap" in props)) {
    			console.warn("<ModalBg> was created without expected prop 'wrap'");
    		}

    		if (/*Component*/ ctx[7] === undefined && !("Component" in props)) {
    			console.warn("<ModalBg> was created without expected prop 'Component'");
    		}
    	}

    	get transitionBg() {
    		throw new Error("<ModalBg>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set transitionBg(value) {
    		throw new Error("<ModalBg>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    	...
    	get handleOuterClick() {
    		throw new Error("<ModalBg>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set handleOuterClick(value) {
    		throw new Error("<ModalBg>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    const file$4 = "src/Images/Modal.svelte";

    // (78:2) <svelte:component     this={isOpen ? ModalBg : null}     {handleOuterClick}     {background}     {wrap}     {Component}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(78:2) <svelte:component     this={isOpen ? ModalBg : null}     {handleOuterClick}     {background}     {wrap}     {Component}>",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let current;
    	let dispose;
    	var switch_value = /*isOpen*/ ctx[2] ? ModalBg : null;

    	function switch_props(ctx) {
    		return {
    			props: {
    				handleOuterClick: /*handleOuterClick*/ ctx[6],
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			if (default_slot) default_slot.c();
    			attr_dev(div, "class", "svelte-sdhtho");
    			add_location(div, file$4, 76, 0, 2032);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, Component, props*/ 33554435) {
    				switch_instance_changes.$$scope = { dirty, ctx };
    			}

    			if (switch_value !== (switch_value = /*isOpen*/ ctx[2] ? ModalBg : null)) {
    				if (switch_instance) {
    					group_outros();
    					const old_component = switch_instance;
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const open = (NewComponent, newProps = {}, style = { bg: {}, window: {}, content: {} }) => {
    		$$invalidate(0, Component = NewComponent);
    		$$invalidate(1, props = newProps);
    		$$invalidate(14, customStyleBg = style.bg || {});
    		$$invalidate(15, customStyleWindow = style.window || {});
    		$$invalidate(16, customStyleContent = style.content || {});
    	};

    	const close = () => {
    		$$invalidate(0, Component = null);
    		$$invalidate(1, props = null);
    		$$invalidate(14, customStyleBg = {});
    		$$invalidate(15, customStyleWindow = {});
    		$$invalidate(16, customStyleContent = {});
    	};
    	...
    	$$self.$set = $$props => {
    		...
    		if ("closeOnEsc" in $$props) $$invalidate(8, closeOnEsc = $$props.closeOnEsc);
    		if ("closeOnOuterClick" in $$props) $$invalidate(9, closeOnOuterClick = $$props.closeOnOuterClick);
    		if ("styleBg" in $$props) $$invalidate(10, styleBg = $$props.styleBg);
    		if ("styleWindow" in $$props) $$invalidate(11, styleWindow = $$props.styleWindow);
    		if ("styleContent" in $$props) $$invalidate(12, styleContent = $$props.styleContent);
    		if ("setContext" in $$props) $$invalidate(13, setContext$1 = $$props.setContext);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("customStyleBg" in $$props) $$invalidate(14, customStyleBg = $$props.customStyleBg);
    		if ("customStyleWindow" in $$props) $$invalidate(15, customStyleWindow = $$props.customStyleWindow);
    		if ("customStyleContent" in $$props) $$invalidate(16, customStyleContent = $$props.customStyleContent);
    		if ("cssBg" in $$props) cssBg = $$props.cssBg;
    		if ("cssWindow" in $$props) cssWindow = $$props.cssWindow;
    		if ("cssContent" in $$props) cssContent = $$props.cssContent;
    ...
    const file$5 = "src/Images/index.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 9, 0, 117);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$6, 13, 0, 205);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
