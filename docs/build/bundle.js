...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	let current;
    	let dispose;
    	const assign_button = () => /*button_binding*/ ctx[12](button, i);
    	const unassign_button = () => /*button_binding*/ ctx[12](null, i);
    ...
    function create_if_block(ctx) {
    	...
    	let current;
    	let dispose;
    	const assign_button = () => /*button_binding_1*/ ctx[13](button, i);
    	const unassign_button = () => /*button_binding_1*/ ctx[13](null, i);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, images, right_nav_buttons, blink, curr_idx, left_nav_buttons*/ 131163) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			current = true;
    			dispose = listen_dev(window_1, "resize", /*handleResize*/ ctx[9], false, false, false);
    		},
    		p: function update(ctx, [dirty]) {
